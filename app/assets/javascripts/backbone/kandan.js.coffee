...
window.Kandan =
  ...
  registerAppEvents: ()->
    ...
    Kandan.Data.Connection.registerCallback "hardchange", Kandan.Views.Chatbox.updateChatStatus('hard')
    Kandan.Data.Connection.registerCallback "softchange", Kandan.Views.Chatbox.updateChatStatus('soft')
